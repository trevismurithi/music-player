    ...
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      <div class="px-6 pt-6 pb-5 font-bold border-b border-gray-200">
        <span class="card-title">
          {{$tc('song.comments',song.comment_count,{count: song.comment_count})}}
        </span>
      ...
      <div class="p-6">
        ...
        <vee-form
          ...
          <button :disabled="comment_in_submission"
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_variant: 'bg-green-500',
  ...
  computed: {
    ...
    sortedComments() {
      return this.comments.slice().sort((a, b) => {
        if (this.sort === '1') {
          return new Date(b.datePosteed) - new Date(a.datePosteed);
        }
        return new Date(a.datePosteed) - new Date(b.datePosteed);
      });
    },
  },
  methods: {
    ...
    async getComments() {
      const snapshots = await commentsCollection.where('sid',
