...
export default createStore({
  ...
  mutations: {
    ...
    newSong(state, payload) {
      if (state.sound instanceof Howl) {
        ...
        state.sound.unload(); // removes the sound from the instance, thus prevents memory leaks
      }
  ...
  actions: {
    ...
    updateSeek({ state, dispatch }, payload) {
      ...
      // Document = 2000, Timeline = 1000, Click=100, Distance = 500
